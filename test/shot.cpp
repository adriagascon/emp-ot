...
int main(int argc, char** argv) {
  ...
  cout << "Semi Honest COT Extension\t"<<double(length)/test_cot_fs<NetIO, SHOTExtension>(io, party, length)*1e6<<" OTps"<<endl;
  cout << "Semi Honest COT Extension\t"<<double(length)/test_cot_add_deltas<NetIO, SHOTExtension>(io, party, length)*1e6<<" OTps"<<endl;
